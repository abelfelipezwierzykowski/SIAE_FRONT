...
export function Home() {
  ...
  const availableAnimals = mockAnimals.filter(a => a.status === 'available');
  const totalDogs = availableAnimals.filter(a => a.species === 'dog').length;
  const totalCats = availableAnimals.filter(a => a.species === 'cat').length;
  const totalSmall = availableAnimals.filter(a => a.size === 'small').length;
  const totalMedium = availableAnimals.filter(a => a.size === 'medium').length;
  const totalLarge = availableAnimals.filter(a => a.size === 'large').length;
  const totalYoung = availableAnimals.filter(a => a.age <= 2).length;
  const totalAdult = availableAnimals.filter(a => a.age > 2 && a.age <= 7).length;
  const totalSenior = availableAnimals.filter(a => a.age > 7).length;
